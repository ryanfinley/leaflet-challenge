...
// call the api to get the tectonic plates
d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json")
.then(function(plateData){
	// console log to ensure the data loads
...
// variable to hold the earthquake data lyaer
...
.then(
	function(earthquakeData){
		...
		L.geoJson(earthquakeData, {
			...
			style: dataStyle, // calls the data style function and passes in earthquakeData
			// add popups
			onEachFeature: function(feature, layer){
				layer.bindPopup(`Magniture: <b>${feature.properties.mag}</b><br>
...
legend.onAdd = function() {
	...
	{
		// inner html that sets the s	uare for each interval and label
